...
ax.set_title('Mean Pressure Distribution (CT)', fontsize = 20)
ax.set_xlabel('ML')
ax.set_ylabel('SI')
...
ax.set_ylabel('SI')
ax.set_zlabel('grams_force (g)')
ax.set_title('Mean Pressure Distribution (Corset)', fontsize = 20)
# ax.set_zlim3d(0,50)
# ax.view_init(30,140)
...
ax.set_ylabel('SI')
ax.set_zlabel('grams_force (g)')
ax.set_title('Mean Pressure Distribution (Board)', fontsize = 20)
# ax.set_zlim3d(0,50)
# ax.view_init(30,140)
